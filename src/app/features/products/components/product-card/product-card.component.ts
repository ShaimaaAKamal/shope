...
//   }
// }
// private emptyBasicInfoErrorMessage(){
...
//   if (!title) {this.englishNameErrorMessage='Name is Required'; return 'missing_title'};
//   if (!Arabictitle) {this.arabicNameErrorMessage='Arabic Name is Required'; ; return 'missing_Arabic_title'};
//   if (!price) {this.priceErrorMessage='Price is Required' ;return 'missing_price'};
...
//   if(result == 'Duplicate_Arabic_Name') this.arabicNameErrorMessage='Name is already Exist';
//   if(result == 'Duplicate_English_Name') this.englishNameErrorMessage='Name is already Exist';
...
//   const result = this.handleProductSave();
//   const dublicateMessag=result == 'Duplicate_Arabic_Name' ? 'Arabic Name': "English Name"
//     if(result == 'Duplicate_Arabic_Name') this.arabicNameErrorMessage='Product is already Exist';
//   if(result == 'Duplicate_English_Name') this.englishNameErrorMessage='Product is already Exist';
//   this.handleSaveResult(
//     result,
//     {
//       success: 'Product has been added successfully',
...
private processProductSave(  action: 'add' | 'update', successMessage: string, duplicatePrefix: string ): void {
  ...
  const duplicateDetail = result === 'Duplicate_Arabic_Name' ? 'Arabic Name' : 'English Name';
